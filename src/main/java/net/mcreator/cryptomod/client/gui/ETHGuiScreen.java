...
public class ETHGuiScreen extends AbstractContainerScreen<ETHGuiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("crypto:textures/eth_gui.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("crypto:textures/eth.png"));
		this.blit(ms, this.leftPos + -38, this.topPos + 28, 0, 0, 32, 32, 32, 32);

		RenderSystem.setShaderTexture(0, new ResourceLocation("crypto:textures/7083.png"));
		this.blit(ms, this.leftPos + 177, this.topPos + 28, 0, 0, 32, 32, 32, 32);

		RenderSystem.setShaderTexture(0, new ResourceLocation("crypto:textures/usdt_coin.png"));
