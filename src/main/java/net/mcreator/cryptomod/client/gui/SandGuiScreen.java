...
public class SandGuiScreen extends AbstractContainerScreen<SandGuiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("crypto:textures/sand_gui.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("crypto:textures/sand_coin.png"));
