...
import net.mcreator.cryptomod.world.inventory.WalletMenu;
import net.mcreator.cryptomod.world.inventory.SandGuiMenu;
import net.mcreator.cryptomod.world.inventory.RigGuiMenu;
import net.mcreator.cryptomod.world.inventory.MANAGuiMenu;
import net.mcreator.cryptomod.world.inventory.KUBGuiMenu;
import net.mcreator.cryptomod.world.inventory.GPUAssemblerMenu;
import net.mcreator.cryptomod.world.inventory.FabMenu;
import net.mcreator.cryptomod.world.inventory.ETHGuiMenu;
import net.mcreator.cryptomod.world.inventory.BnbguiMenu;
