...
import net.mcreator.cryptomod.item.inventory.EthwalletInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class EthwalletItem extends Item {
	public EthwalletItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1).rarity(Rarity.COMMON));
		setRegistryName("ethwallet");
	}
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new EthwalletInventoryCapability();
	}
