...
import net.mcreator.cryptomod.procedures.CSelect1Procedure;
import net.mcreator.cryptomod.procedures.CSelect0Procedure;
...
public class RigGuiButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CryptoMod.addNetworkMessage(RigGuiButtonMessage.class, RigGuiButtonMessage::buffer, RigGuiButtonMessage::new, RigGuiButtonMessage::handler);
	}
}
