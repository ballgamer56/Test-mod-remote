...
package net.mcreator.cryptomod.world.biome;
...
public class CrypticSphereBiome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.configured(new SurfaceBuilderBaseConfiguration(CryptoModBlocks.CRYPT_STONE.defaultBlockState(),
					CryptoModBlocks.CRYPT_STONE.defaultBlockState(), CryptoModBlocks.CRYPT_STONE.defaultBlockState()));
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(CryptoMod.MODID, "cryptic_sphere"), SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(CryptoMod.MODID, name + "_cryptic_sphere"), configuredFeature);
