...
public class ETHOreFeature extends OreFeature {
	public static final ETHOreFeature FEATURE = (ETHOreFeature) new ETHOreFeature().setRegistryName("crypto:eth_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(ETHOreFeatureRuleTest.INSTANCE, CryptoModBlocks.ETH_ORE.defaultBlockState(), 16))
	...
	private static class ETHOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<ETHOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("crypto:eth_ore_match"), () -> codec);
