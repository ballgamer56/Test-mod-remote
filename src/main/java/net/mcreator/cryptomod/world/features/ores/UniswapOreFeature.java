...
public class UniswapOreFeature extends OreFeature {
	public static final UniswapOreFeature FEATURE = (UniswapOreFeature) new UniswapOreFeature().setRegistryName("crypto:uniswap_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(UniswapOreFeatureRuleTest.INSTANCE, CryptoModBlocks.UNISWAP_ORE.defaultBlockState(), 8))
	...
	private static class UniswapOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<UniswapOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("crypto:uniswap_ore_match"), () -> codec);
