...
public class BinanceMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BinanceMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CryptoModMenus.BINANCE, id);
