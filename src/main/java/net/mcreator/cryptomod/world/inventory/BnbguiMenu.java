...
public class BnbguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BnbguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CryptoModMenus.BNBGUI, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 26) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.BNBCOIN == stack.getItem());
			}
		}));
