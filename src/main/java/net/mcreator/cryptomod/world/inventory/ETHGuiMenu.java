...
public class ETHGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ETHGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CryptoModMenus.ETH_GUI, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 38) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.ETHEREUM == stack.getItem());
			}
		}));
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 97, 38) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.UNISWAPCOIN == stack.getItem());
			}
		}));
		...
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 7, 74) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.USDTCOIN == stack.getItem());
			}
		}));
		...
		this.customSlots.put(17, this.addSlot(new SlotItemHandler(internal, 17, 7, 92) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.USDT_9 == stack.getItem());
			}
		}));
		...
		this.customSlots.put(21, this.addSlot(new SlotItemHandler(internal, 21, 79, 92) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.USDT_81 == stack.getItem());
			}
		}));
		...
		this.customSlots.put(24, this.addSlot(new SlotItemHandler(internal, 24, 133, 92) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.USDT_729 == stack.getItem());
			}
		}));
		this.customSlots.put(25, this.addSlot(new SlotItemHandler(internal, 25, 151, 92) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.USDT_6561 == stack.getItem());
			}
		}));
