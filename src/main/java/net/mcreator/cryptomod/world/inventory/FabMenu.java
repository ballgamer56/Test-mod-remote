...
public class FabMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FabMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CryptoModMenus.FAB, id);
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 115, 26) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.SILICON == stack.getItem());
			}
		}));
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 79, 107) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
