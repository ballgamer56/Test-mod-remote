...
public class KUBGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public KUBGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CryptoModMenus.KUB_GUI, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 26) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.KUBCOIN == stack.getItem());
			}
		}));
