...
public class MANAGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MANAGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CryptoModMenus.MANA_GUI, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 26) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.MANACOIN == stack.getItem());
			}
		}));
