...
public class RigGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RigGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CryptoModMenus.RIG_GUI, id);
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 8, 79) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.CPU == stack.getItem());
			}
		}));
