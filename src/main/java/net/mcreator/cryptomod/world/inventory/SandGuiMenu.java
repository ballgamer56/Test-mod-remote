...
public class SandGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SandGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CryptoModMenus.SAND_GUI, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 26) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.SANDCOIN == stack.getItem());
			}
		}));
