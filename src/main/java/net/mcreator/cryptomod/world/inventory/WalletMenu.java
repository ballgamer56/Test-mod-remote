...
public class WalletMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WalletMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CryptoModMenus.WALLET, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 26) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (CryptoModItems.DOGECOIN == stack.getItem());
			}
		}));
