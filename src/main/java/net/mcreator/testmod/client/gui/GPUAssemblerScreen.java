...
import net.mcreator.testmod.procedures.PlasticProgress1Procedure;
import net.mcreator.testmod.procedures.PlasticProgress0Procedure;
...
public class GPUAssemblerScreen extends AbstractContainerScreen<GPUAssemblerMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("test_mod:textures/plasticmaker.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("test_mod:textures/sieve.png"));
		this.blit(ms, this.leftPos + 39, this.topPos + 78, 0, 0, 96, 16, 96, 16);

		if (PlasticProgress0Procedure.execute(world, x, y, z)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("test_mod:textures/blade1.png"));
			this.blit(ms, this.leftPos + 69, this.topPos + 41, 0, 0, 32, 32, 32, 32);
		}
		if (PlasticProgress1Procedure.execute(world, x, y, z)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("test_mod:textures/blade2.png"));
			this.blit(ms, this.leftPos + 69, this.topPos + 41, 0, 0, 32, 32, 32, 32);
		}
