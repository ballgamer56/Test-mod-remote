...
public class BTCOreFeature extends OreFeature {
	public static final BTCOreFeature FEATURE = (BTCOreFeature) new BTCOreFeature().setRegistryName("test_mod:btc_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(BTCOreFeatureRuleTest.INSTANCE, TestModModBlocks.BTC_ORE.defaultBlockState(), 8))
	...
	private static class BTCOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<BTCOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("test_mod:btc_ore_match"), () -> codec);
