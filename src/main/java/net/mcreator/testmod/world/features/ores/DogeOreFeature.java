...
public class DogeOreFeature extends OreFeature {
	public static final DogeOreFeature FEATURE = (DogeOreFeature) new DogeOreFeature().setRegistryName("test_mod:doge_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(DogeOreFeatureRuleTest.INSTANCE, TestModModBlocks.DOGE_ORE.defaultBlockState(), 16))
	...
	private static class DogeOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<DogeOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("test_mod:doge_ore_match"), () -> codec);
